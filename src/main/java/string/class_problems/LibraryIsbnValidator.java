...
public class LibraryIsbnValidator {
    public static void main(String[] args) {
        ...
        String raw1 = validator.normalizeCode("   pen2026004251   ");
        System.out.println(validator.validateAndFormat(raw1));
        
        String raw2 = validator.normalizeCode("12N2026004251");
        System.out.println(validator.validateAndFormat(raw2));
    }
